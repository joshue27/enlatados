...
public class ReporteVehiculoService {
    ...
    public static Graph generarGrafico(Cola cola) {
        ...
        while (actual != null) {
            ...
            Node nodo = node("n" + i).with("label",
                    v.getPlaca() + "\\n" + v.getMarca() + " " + v.getModelo() + " - " + v.getColor() + " " + v.getAnio()
            );
            nodos.add(nodo);
        ...
        Graph g = graph("vehiculos").directed();
    ...
    public static String generarReporte(Cola cola) throws IOException {
        ...
        String ruta = "reporte_vehiculos.png";
